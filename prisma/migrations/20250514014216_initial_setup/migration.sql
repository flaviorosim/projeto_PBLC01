...
-- CreateIndex
CREATE UNIQUE INDEX "Reservation_hostId_key" ON "Reservation"("hostId");
...
-- AddForeignKey
ALTER TABLE "Reservation" ADD CONSTRAINT "Reservation_hostId_fkey" FOREIGN KEY ("hostId") REFERENCES "Host"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
